...
public class KenwoodRadio : IKenwoodRadio, IDisposable
{
    ...
    public async Task<bool> ConnectAsync(CancellationToken cancellationToken)
    {
        ...
        while (!_clientSocket.Connected)
        {
            ...
            try
            {
                await _clientSocket.ConnectAsync(_ipEndpoint, cancellationToken).ConfigureAwait(false);
            }
        ...
        var connectResponse = await SendAsync(ConnectCommand, cancellationToken).ConfigureAwait(false);
        ...
        var idResponse = await SendAsync(idCommand, cancellationToken).ConfigureAwait(false);
        ...
        var aiGetResponse = await SendAsync(AIGetCommand, cancellationToken).ConfigureAwait(false);
